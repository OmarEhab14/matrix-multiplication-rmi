...
public class ClientMain {
    public static void main(String[] args) {
        try {
            MatrixWorker worker1 = connect("localhost", 1099);
//            MatrixWorker worker2 = connect("localhost", 1100);
            ...
            PartialResult r1 = worker1.multiplyRows(A, B, 0);
